...
@synthesize swipeRecognizer, tapRecognizer, slideImageView, tapImageView;
...
- (void)viewDidLoad {
  ...
  self.view.autoresizingMask = (UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight);
    ...
    UIImageView *aSlideImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, 1024.0, 768.0)];
